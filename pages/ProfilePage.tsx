...
const ProfilePage: React.FC = () => {
    ...
    const profileData = walletAddress ? getUserProfileByWallet(walletAddress) : null;
    ...
    const fundedProjects = (isOwnProfile && loggedInUser)
            ...
            <div className="p-6 bg-brand-surface/60 backdrop-blur-lg border border-white/10 rounded-xl">
                <div className="flex flex-col sm:flex-row items-center gap-6">
                    ...
                    <div className="text-center sm:text-left min-w-0 flex-1">
                        ...
                        <button onClick={handleCopyAddress} className="group inline-flex items-center justify-center sm:justify-start gap-2 mt-1 text-brand-muted hover:text-white transition-colors focus:outline-none" title="Copy address">
                        ...
                        <div className="mt-4 flex items-center justify-center sm:justify-start gap-4">
                            {twitterHandle && <SocialIcon url={`https://twitter.com/${twitterHandle}`} style={{ height: 24, width: 24 }} bgColor="transparent" fgColor="#888888" />}
