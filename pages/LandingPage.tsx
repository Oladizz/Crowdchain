        ...
        <div className="bg-black/20 backdrop-blur-lg border border-white/10 rounded-3xl shadow-2xl p-8 md:p-12 max-w-2xl mx-auto">
            ...
            <div className="mt-10 animate-slide-in-bottom" style={{ animationDelay: '1.5s' }} data-guide="enter-app">
                <Link to="/home">
                    <Button 
                        variant="primary" 
                        className="text-lg px-10 py-4 rounded-full shadow-lg shadow-brand-blue/30 transition-all duration-300 hover:shadow-2xl hover:shadow-brand-blue/50 hover:scale-105"
                    >
                        Enter Platform
                    </Button>
                </Link>
