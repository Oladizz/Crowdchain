...
const DashboardPage: React.FC = () => {
    ...
    const handleConnectClick = () => {
        ...
        setConnectClickCount(prev => prev + 1);
    ...
    if (!user) {
        ...
        return (
            ...
            <div className="text-center py-20 animate-fade-in">
                ...
                <Button onClick={handleConnectClick} variant="primary" className="mt-8">Connect Wallet</Button>


                {connectClickCount >= 2 && (


                    <div className="mt-4 flex items-center justify-center text-sm text-brand-muted">


                        <InfoIcon className="w-5 h-5 mr-2" />


                        <span>If your wallet does not connect, please unlock your wallet, reload the page, and try again.</span>
